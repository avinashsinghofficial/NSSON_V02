...
# =========================================================
# FIGURE 1: Baseline vs NSSON overview
# =========================================================
...
fig.suptitle("Baseline vs NSSON Overview", fontsize=16, fontweight="bold", y=1.02)
fig.subplots_adjust(wspace=0.25, hspace=0.35)
savefig(fig, "baseline_vs_nsson_overview_templated.png")

# =========================================================
# FIGURE 2: Latency vs nodes
# =========================================================
...
ax.set_title("Power Consumption Across Node Scales")
ax.set_xlabel("Nodes")
ax.set_ylabel("Power (mW)")
savefig(fig, "power_vs_nodes_templated.png")

# =========================================================
# FIGURE 5: Accuracy vs nodes
# =========================================================
fig, ax = plt.subplots(figsize=(8.8, 5.2))
sns.lineplot(
    data=summary.sort_values(["model", "architecture", "nodes_num"]),
...
# =========================================================
# FIGURE 8: Local vs offload latency across nodes
# =========================================================
...
# =========================================================
# FIGURE 9: Decision ratio by node count
# =========================================================
...
if {"nodes_num", "threshold", "architecture"}.issubset(telemetry.columns):
    ...
    ax.set_title("Adaptive Threshold Evolution Across Nodes")
    ax.set_xlabel("Nodes")
...
# =========================================================
# FIGURE 12: Offload telemetry panel
# =========================================================
if {"decision", "nodes_num", "total_latency_ms", "threshold", "effective_power_mw"}.issubset(telemetry.columns):
    ...
    axs[1, 1].set_title("Adaptive Threshold vs Nodes")
